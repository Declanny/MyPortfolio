"use client"; // Only one "use client" directive at the top
...
const Meteors = ({ number = 20 }: MeteorsProps) => {
  ...
  useEffect(() => {
    // Check if window is available to avoid server-side rendering issues
...
export default Meteors; // Use `default export` to avoid import issues
